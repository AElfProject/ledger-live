...
describe("AElf app binding", () => {
  ...
  test("getAddress", async () => {
    ...
    const elf = new Elf(transport);
    const result = await elf.getAddress("44'/1616'/0'/0'/0");
  ...
  test("getAddress with display", async () => {
    ...
    const elf = new Elf(transport);
    const result = await elf.getAddress("44'/1616'/0'/0'/0", true);
  ...
  test("getAddress with chainCode", async () => {
    ...
    const elf = new Elf(transport);
    const result = await elf.getAddress("44'/1616'/0'/0'/0", false, true);
